...
![Архитектура frontend](https://sun9-47.userapi.com/impg/-DRNggSTERlKcE2rN22B8Za9lJ4j7e4mvdDMdg/MGwPgfHwXXc.jpg?size=821x151&quality=96&sign=3bfb4de8f46d7dfadce73f87c5d73aeb&type=album)
...
- Адаптивные компоненты
    > Приспосабливаются к размерам экрана (например с помощью меди запросов в css)
...
>  - Скорость разработки
>  - Ожидается относительно низкая нагрузка на систему (менее 100 пользователей в пиковые часы)
...
const developmentStages = `# Рекомендованные этапы разработки
